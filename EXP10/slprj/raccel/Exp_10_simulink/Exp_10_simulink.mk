...
MODEL                = Exp_10_simulink
MODULES              = rt_matrx.c rt_printf.c rt_logging.c Exp_10_simulink.c Exp_10_simulink_capi.c Exp_10_simulink_data.c Exp_10_simulink_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_spid_contc.c
PRODUCT              = Exp_10_simulink.exe
MAKEFILE             = Exp_10_simulink.mk
...
START_DIR            = C:/Users/SWARUP/Desktop/EEE/2-2/EEEF24~1/LABS/EXP10
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Exp_10_simulink_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/Exp_10_simulink \
...
sfun_spid_contc.obj : $(MATLAB_ROOT)\toolbox\physmod\powersys\powersys/sfun_spid_contc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)\toolbox\physmod\powersys\powersys/sfun_spid_contc.c
